...
enum opt_code
{
  ...
  OPT_mbionic = 1287,                        /* -mbionic */
  OPT_mbranch_cost_ = 1288,                  /* -mbranch-cost= */
  OPT_mcallee_super_interworking = 1289,     /* -mcallee-super-interworking */
  OPT_mcaller_super_interworking = 1290,     /* -mcaller-super-interworking */
  OPT_mcmse = 1291,                          /* -mcmse */
  OPT_mcpu_ = 1292,                          /* -mcpu= */
  OPT_mfix_cortex_m3_ldrd = 1293,            /* -mfix-cortex-m3-ldrd */
  OPT_mflip_thumb = 1294,                    /* -mflip-thumb */
  OPT_mfloat_abi_ = 1295,                    /* -mfloat-abi= */
  OPT_mfp16_format_ = 1296,                  /* -mfp16-format= */
  OPT_mfpu_ = 1297,                          /* -mfpu= */
  OPT_mgeneral_regs_only = 1298,             /* -mgeneral-regs-only */
  OPT_mglibc = 1299,                         /* -mglibc */
  /* OPT_mhard_float = 1300, */              /* -mhard-float */
  OPT_mlittle_endian = 1301,                 /* -mlittle-endian */
  OPT_mlong_calls = 1302,                    /* -mlong-calls */
  OPT_mmusl = 1303,                          /* -mmusl */
  OPT_mneon_for_64bits = 1304,               /* -mneon-for-64bits */
  OPT_mpic_data_is_text_relative = 1305,     /* -mpic-data-is-text-relative */
  OPT_mpic_register_ = 1306,                 /* -mpic-register= */
  OPT_mpoke_function_name = 1307,            /* -mpoke-function-name */
  OPT_mprint_tune_info = 1308,               /* -mprint-tune-info */
  OPT_mpure_code = 1309,                     /* -mpure-code */
  OPT_mrestrict_it = 1310,                   /* -mrestrict-it */
  OPT_msched_prolog = 1311,                  /* -msched-prolog */
  OPT_msingle_pic_base = 1312,               /* -msingle-pic-base */
  OPT_mslow_flash_data = 1313,               /* -mslow-flash-data */
  /* OPT_msoft_float = 1314, */              /* -msoft-float */
  OPT_mstructure_size_boundary_ = 1315,      /* -mstructure-size-boundary= */
  OPT_mthumb = 1316,                         /* -mthumb */
  OPT_mthumb_interwork = 1317,               /* -mthumb-interwork */
  OPT_mtls_dialect_ = 1318,                  /* -mtls-dialect= */
  OPT_mtp_ = 1319,                           /* -mtp= */
  OPT_mtpcs_frame = 1320,                    /* -mtpcs-frame */
  OPT_mtpcs_leaf_frame = 1321,               /* -mtpcs-leaf-frame */
  OPT_mtune_ = 1322,                         /* -mtune= */
  OPT_muclibc = 1323,                        /* -muclibc */
  OPT_munaligned_access = 1324,              /* -munaligned-access */
  OPT_mvectorize_with_neon_double = 1325,    /* -mvectorize-with-neon-double */
  OPT_mvectorize_with_neon_quad = 1326,      /* -mvectorize-with-neon-quad */
  OPT_mverbose_cost_dump = 1327,             /* -mverbose-cost-dump */
  OPT_mword_relocations = 1328,              /* -mword-relocations */
  OPT_n = 1329,                              /* -n */
  OPT_no_canonical_prefixes = 1330,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1331,              /* -no-integrated-cpp */
  OPT_no_pie = 1332,                         /* -no-pie */
  OPT_nocpp = 1333,                          /* -nocpp */
  OPT_nodefaultlibs = 1334,                  /* -nodefaultlibs */
  OPT_nolibc = 1335,                         /* -nolibc */
  OPT_nophoboslib = 1336,                    /* -nophoboslib */
  ...
  OPT_s = 1367,                              /* -s */
  OPT_save_temps = 1368,                     /* -save-temps */
  OPT_save_temps_ = 1369,                    /* -save-temps= */
  OPT_shared = 1370,                         /* -shared */
  OPT_shared_libgcc = 1371,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1372,               /* -shared-libphobos */
  ...
  OPT_static_libgfortran = 1378,             /* -static-libgfortran */
  OPT_static_libgo = 1379,                   /* -static-libgo */
  OPT_static_liblsan = 1380,                 /* -static-liblsan */
  OPT_static_libmpx = 1381,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1382,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 1383,               /* -static-libphobos */
  OPT_static_libstdc__ = 1384,               /* -static-libstdc++ */
  OPT_static_libtsan = 1385,                 /* -static-libtsan */
  OPT_static_libubsan = 1386,                /* -static-libubsan */
  OPT_static_pie = 1387,                     /* -static-pie */
  ...
  OPT_std_c__2a = 1395,                      /* -std=c++2a */
  OPT_std_c__98 = 1396,                      /* -std=c++98 */
  OPT_std_c11 = 1397,                        /* -std=c11 */
  OPT_std_c17 = 1398,                        /* -std=c17 */
  /* OPT_std_c18 = 1399, */                  /* -std=c18 */
  /* OPT_std_c1x = 1400, */                  /* -std=c1x */
  OPT_std_c2x = 1401,                        /* -std=c2x */
  /* OPT_std_c89 = 1402, */                  /* -std=c89 */
  OPT_std_c90 = 1403,                        /* -std=c90 */
  OPT_std_c99 = 1404,                        /* -std=c99 */
  /* OPT_std_c9x = 1405, */                  /* -std=c9x */
  OPT_std_f2003 = 1406,                      /* -std=f2003 */
  OPT_std_f2008 = 1407,                      /* -std=f2008 */
  OPT_std_f2008ts = 1408,                    /* -std=f2008ts */
  OPT_std_f2018 = 1409,                      /* -std=f2018 */
  ...
  OPT_std_gnu__2a = 1419,                    /* -std=gnu++2a */
  OPT_std_gnu__98 = 1420,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 1421,                      /* -std=gnu11 */
  OPT_std_gnu17 = 1422,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 1423, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 1424, */                /* -std=gnu1x */
  OPT_std_gnu2x = 1425,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 1426, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1427,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1428,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1429, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1430, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1431,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1432, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1433, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 1434, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 1435, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 1436, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 1437,                     /* -std=legacy */
  OPT_symbolic = 1438,                       /* -symbolic */
  OPT_t = 1439,                              /* -t */
  OPT_time = 1440,                           /* -time */
  OPT_time_ = 1441,                          /* -time= */
  OPT_tno_android_cc = 1442,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1443,                 /* -tno-android-ld */
  OPT_traditional = 1444,                    /* -traditional */
  OPT_traditional_cpp = 1445,                /* -traditional-cpp */
  OPT_trigraphs = 1446,                      /* -trigraphs */
  OPT_u = 1447,                              /* -u */
  OPT_undef = 1448,                          /* -undef */
  OPT_v = 1449,                              /* -v */
  OPT_version = 1450,                        /* -version */
  OPT_w = 1451,                              /* -w */
  OPT_wrapper = 1452,                        /* -wrapper */
  OPT_x = 1453,                              /* -x */
  OPT_z = 1454,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
