...
#define gp2x_color32(R,G,B)  (0xFF000000 | (R << 16) | (G << 8) | B)
#define gp2x_col16to32(C) \
	(0xFF000000|((((C)>>8)&0xF8) << 16)|((((C)>>3)&0xF8) << 8)|(((C)<<3)&0xF8))
