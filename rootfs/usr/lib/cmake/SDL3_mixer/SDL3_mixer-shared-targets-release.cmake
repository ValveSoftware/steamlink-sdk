...
set_target_properties(SDL3_mixer::SDL3_mixer-shared PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libSDL3_mixer.so.0.0.0"
  IMPORTED_SONAME_RELEASE "libSDL3_mixer.so.0"
  )

list(APPEND _cmake_import_check_targets SDL3_mixer::SDL3_mixer-shared )
list(APPEND _cmake_import_check_files_for_SDL3_mixer::SDL3_mixer-shared "${_IMPORT_PREFIX}/lib/libSDL3_mixer.so.0.0.0" )
