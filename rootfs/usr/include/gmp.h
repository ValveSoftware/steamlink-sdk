...
#define __GMP_CC "armv7a-cros-linux-gnueabi-gcc --sysroot=/valve/marvell/steamlink-fw/MRVL/MV88DE3100_SDK/Customization_Data/File_Systems/rootfs_valve -marm -mfloat-abi=hard -std=gnu99"
