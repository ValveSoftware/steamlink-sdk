...
#endif
typedef void (*SDL_SteamControllerEnumCallback)( void *pContext, SDL_JoystickID unJoystickID, int nDevice, int nFD, bool bWireless, bool bConnected );
extern SDL_DECLSPEC void SDLCALL SDL_EnumSteamControllers( SDL_SteamControllerEnumCallback callback, void *pContext );
