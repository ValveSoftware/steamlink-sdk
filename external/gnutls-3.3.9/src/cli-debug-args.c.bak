 ...
 */
static char const gnutls_cli_debug_opt_strs[1929] =
/*     0 */ "gnutls-cli-debug 3.3.9\n"
            "Copyright (C) 2000-2014 Free Software Foundation, and others, all rights reserved.\n"
            "This is free software. It is licensed for use, modification and\n"
            "redistribution under the terms of the GNU General Public License,\n"
            "version 3 or later <http://gnu.org/licenses/gpl.html>\n\0"
...
/*  1000 */ "PORT\0"
/*  1005 */ "port\0"
/*  1010 */ "The application protocol to be used to obtain the server's certificate\n"
            "(https, smtp, imap)\0"
/*  1101 */ "APP_PROTO\0"
/*  1111 */ "app-proto\0"
...
/*  1261 */ "version\0"
/*  1269 */ "GNUTLS_CLI_DEBUG\0"
/*  1286 */ "gnutls-cli-debug - GnuTLS debug client\n"
            "Usage:  %s [ -<flag> [<val>] | --<name>[{=| }<val>] ]... \n\0"
/*  1384 */ "bugs@gnutls.org\0"
/*  1400 */ "\n\0"
/*  1402 */ "TLS debug client.  It sets up multiple TLS connections to a server and\n"
...
/*  1820 */ "gnutls-cli-debug 3.3.9\0"
/*  1843 */ "Usage: gnutls-cli-debug [options] hostname\n"
...
#define APP_PROTO_NAME      (gnutls_cli_debug_opt_strs+1101)
/** Name string for the app-proto option */
#define APP_PROTO_name      (gnutls_cli_debug_opt_strs+1111)
 ...
 */
#define HELP_DESC       (gnutls_cli_debug_opt_strs+1121)
#define HELP_name       (gnutls_cli_debug_opt_strs+1165)
#ifdef HAVE_WORKING_FORK
#define MORE_HELP_DESC  (gnutls_cli_debug_opt_strs+1170)
#define MORE_HELP_name  (gnutls_cli_debug_opt_strs+1215)
...
#endif
#define VER_DESC        (gnutls_cli_debug_opt_strs+1225)
#define VER_name        (gnutls_cli_debug_opt_strs+1261)
/**
...
#define zPROGNAME       (gnutls_cli_debug_opt_strs+1269)
/** Reference to the title line for gnutls-cli-debug usage. */
#define zUsageTitle     (gnutls_cli_debug_opt_strs+1286)
...
#define zBugsAddr       (gnutls_cli_debug_opt_strs+1384)
/** Clarification/explanation of what gnutls-cli-debug does. */
#define zExplain        (gnutls_cli_debug_opt_strs+1400)
/** Extra detail explaining what gnutls-cli-debug does. */
#define zDetail         (gnutls_cli_debug_opt_strs+1402)
/** The full version string for gnutls-cli-debug. */
#define zFullVersion    (gnutls_cli_debug_opt_strs+1820)
...
#define gnutls_cli_debug_short_usage (gnutls_cli_debug_opt_strs+1843)
