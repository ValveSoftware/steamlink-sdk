...
static DBusMessage *characteristic_write_value_without_response(DBusConnection *conn,
					DBusMessage *msg, void *user_data)
{
	struct characteristic *chrc = user_data;
	struct bt_gatt_client *gatt = chrc->service->client->gatt;
...
static const GDBusMethodTable characteristic_methods[] = {
	...
	{ GDBUS_EXPERIMENTAL_ASYNC_METHOD("WriteValueWithoutResponse",
						GDBUS_ARGS({ "value", "ay" }),
						NULL,
						characteristic_write_value_without_response) },
