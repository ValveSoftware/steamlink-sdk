...
static const GDBusPropertyInfo bluez_iface_mediaplayer_CanQuit = {
	-1, "CanQuit",
	"b",
...
static const GDBusPropertyInfo bluez_iface_mediaplayer_CanRaise = {
	-1, "CanRaise",
	"b",
	G_DBUS_PROPERTY_INFO_FLAGS_READABLE,
	NULL,
...
static const GDBusPropertyInfo bluez_iface_mediaplayer_HasTrackList = {
	-1, "HasTrackList",
	"b",
	G_DBUS_PROPERTY_INFO_FLAGS_READABLE,
	NULL,
...
static const GDBusPropertyInfo bluez_iface_mediaplayer_Identity = {
	-1, "Identity",
	"s",
	G_DBUS_PROPERTY_INFO_FLAGS_READABLE,
	NULL,
...
static const GDBusPropertyInfo bluez_iface_mediaplayer_SupportedUrisSchemes = {
...
static const GDBusPropertyInfo bluez_iface_mediaplayer_SupportedMimeTypes = {
	-1, "SupportedMimeTypes",
	"as",
	G_DBUS_PROPERTY_INFO_FLAGS_READABLE,
	NULL,
};

static const GDBusPropertyInfo *bluez_iface_mediaplayer_properties[] = {
	&bluez_iface_mediaplayer_CanRaise,
	&bluez_iface_mediaplayer_CanQuit,
	&bluez_iface_mediaplayer_HasTrackList,
	&bluez_iface_mediaplayer_Identity,
	&bluez_iface_mediaplayer_SupportedUrisSchemes,
	&bluez_iface_mediaplayer_SupportedMimeTypes,
	NULL,
};
...
const GDBusInterfaceInfo bluez_iface_mediaplayer = {
	-1, "org.mpris.MediaPlayer2",
	NULL,
	NULL,
	(GDBusPropertyInfo **)bluez_iface_mediaplayer_properties,
	NULL,
};
