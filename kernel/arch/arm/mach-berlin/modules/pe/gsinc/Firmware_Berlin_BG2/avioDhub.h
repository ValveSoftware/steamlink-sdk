...
#define avioDhub_h (){}
    ...
    #define        avioDhubChMap_vip_HDMI_DWR                               0x2
    #define        avioDhubChMap_vip_HDMI_AWR0                              0x3
    #define        avioDhubChMap_vip_HDMI_AWR1                              0x4
    #define        avioDhubChMap_vip_HDMI_AWR2                              0x5
    #define        avioDhubChMap_vip_HDMI_AWR3                              0x6
    #define        avioDhubChMap_vip_DVI_WR                                 0x7
    #define        avioDhubChMap_vip_VBI_WR                                 0x8
    ...
    #define        avioDhubSemMap_vip_hdmi_vde_intr                         0x12
    #define        avioDhubSemMap_vip_dvi_vde_intr                          0x13
    #define        avioDhubSemMap_vip_hdmirx_intr                           0x14
    #define        avioDhubSemMap_vip_hdmiaud_intr                          0x15
